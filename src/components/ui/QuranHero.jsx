...
const QuranHero = React.forwardRef(
  (
    {
      className,
      gradient = true,
      ...
      >
        {gradient && (
          <div className="absolute top-0 isolate z-0 flex w-screen flex-1 items-start justify-center">
            ...
            {/* Main glow - green theme */}
            <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-[-30%] rounded-full bg-primary/40 opacity-60 blur-3xl" />
        ...
        >
          <div className="flex flex-col items-center text-center space-y-6">
            {arabicText && (
              <h1
                className={cn(
                  "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-gray-800 leading-relaxed",
                )}
                dir="rtl"
            ...
            {englishText && (
              <p
                className={cn(
                  "text-lg md:text-xl text-gray-700 italic max-w-4xl leading-relaxed",
                )}
              >
                {englishText}
              </p>
            ...
            {verseReference && (
              <p className={cn("text-primary font-semibold text-lg md:text-xl")}>
                {verseReference}
              </p>
            )}
          </div>
...
QuranHero.displayName = "QuranHero"
